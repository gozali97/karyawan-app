        ...
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex justify-start items-center">
                ...
                <a href="#" class="flex items-center justify-between mr-4">
                    <img
                        src="https://www.shareicon.net/data/128x128/2017/07/13/888373_idea_512x512.png"
                        class="mr-3 h-8"
                        alt="Flowbite Logo"
                    />
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">K-APP</span>
                </a>
            </div>
